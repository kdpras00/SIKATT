...
<div class="content">
    ...
    <table class="table-data">
        ...
        <tr>
            <td class="label-col">Alamat Asal</td>
            <td class="separator-col">:</td>
    ...
    <p>
        Benar menurut keterangan dari RT/RW setempat dan keterangan yang bersangkutan, bahwa
        <strong>{{ strtoupper($letter->user->name) }}</strong> pada saat ini telah berdomisili di:
    </p>

    <p style="font-weight: bold; margin: 5px 0 5px 15px;">
