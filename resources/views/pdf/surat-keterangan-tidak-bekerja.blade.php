...
<head>
    ...
    @php
        $sifat    = 'Biasa';
        $lampiran = '-';
        $hal      = 'Surat Keterangan Tidak Bekerja';
        $data     = $letter->data ?? [];
...
<div class="content">
    ...
    <p>
        ...
        Berdasarkan keterangan dari RT/RW setempat, dan pengakuan yang bersangkutan bahwa benar pada saat ini
        <u><strong>BELUM / TIDAK BEKERJA</strong></u>.
    </p>
