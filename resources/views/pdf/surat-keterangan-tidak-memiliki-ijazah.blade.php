...
<head>
    ...
    @php
        $sifat    = 'Biasa';
        $lampiran = '-';
        $hal      = 'Surat Keterangan Tidak Memiliki Ijazah';
        $data     = $letter->data ?? [];
...
<div class="content">
    ...
    <p>
        Nama tersebut diatas adalah benar Penduduk Kelurahan Tanah Tinggi Kecamatan Tangerang Kota Tangerang.
        Berdasarkan keterangan dari RT/RW setempat, dan pengakuan yang bersangkutan bahwa benar yang bersangkutan
        <u><strong>TIDAK MEMILIKI IJAZAH</strong></u>.
    </p>

    <p>Demikian surat keterangan ini dibuat dengan sebenarnya untuk dapat diketahui semestinya. Atas kerjasamanya kami ucapkan terimakasih.</p>
