...
@section('title', 'Edit Pengguna - Kelurahan Tanah Tinggi')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="p-8">
            <form action="{{ route('staff.users.update', $user) }}" method="POST" class="space-y-8">
                @csrf
                @method('PUT')
                         ...
                         <div>
                            ...
                            <div class="relative">
                                ...
                                <select name="role" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-3 transition-all focus:bg-white appearance-none">
                                    ...
                                    <option value="lurah" {{ old('role', $user->role) == 'lurah' ? 'selected' : '' }}>Lurah</option>
                                </select>
